...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.plaintext'
        db.alter_column('mainapp_email', 'plaintext', self.gf('django.db.models.fields.CharField')(max_length=90000))


    def backwards(self, orm):
        
        # Changing field 'Email.plaintext'
        db.alter_column('mainapp_email', 'plaintext', self.gf('django.db.models.fields.CharField')(max_length=1000))
