...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email.plaintext'
        db.add_column('mainapp_email', 'plaintext', self.gf('django.db.models.fields.CharField')(default='', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email.plaintext'
        db.delete_column('mainapp_email', 'plaintext')
    ...
    models = {
        ...
        'mainapp.email': {
            ...
            'plaintext': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
