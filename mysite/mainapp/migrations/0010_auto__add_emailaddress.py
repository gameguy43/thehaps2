...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mainapp_emailaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mainapp_emailaddress_related', to=orm['auth.User'])),
            ('email_address', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('mainapp', ['EmailAddress'])


    def backwards(self, orm):
        
        # Deleting model 'EmailAddress'
        db.delete_table('mainapp_emailaddress')
