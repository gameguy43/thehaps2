...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CalendarItem.info'
        db.alter_column('mainapp_calendaritem', 'info', self.gf('django.db.models.fields.CharField')(max_length=90000))

        # Changing field 'CalendarItem.name'
        db.alter_column('mainapp_calendaritem', 'name', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'CalendarItem.location'
        db.alter_column('mainapp_calendaritem', 'location', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Email.from_field'
        db.alter_column('mainapp_email', 'from_field', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'CalendarItem.info'
        db.alter_column('mainapp_calendaritem', 'info', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CalendarItem.name'
        db.alter_column('mainapp_calendaritem', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CalendarItem.location'
        db.alter_column('mainapp_calendaritem', 'location', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Email.from_field'
        db.alter_column('mainapp_email', 'from_field', self.gf('django.db.models.fields.CharField')(max_length=100))
