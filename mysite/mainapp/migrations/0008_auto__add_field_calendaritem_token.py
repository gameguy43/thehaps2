...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CalendarItem.token'
        db.add_column('mainapp_calendaritem', 'token', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CalendarItem.token'
        db.delete_column('mainapp_calendaritem', 'token')
